...
for (species in all_features$name){
  #print(species)
  curr_mean_TC <- mean(original_df[original_df$Treatment=="Ticarcillin-Clavulanate",species])
  curr_mean_Amp <-  mean(original_df[original_df$Treatment=="Ampicillin/Meropenem",species])
